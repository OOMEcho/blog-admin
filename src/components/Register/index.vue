    ...
    <div class="register-shell">
      <section class="register-hero">
        ...
        <div class="hero-content">
          ...
          <p class="hero-subtitle">加入我们，开启属于你的内容创作之旅</p>
        </div>
        <div class="hero-characters">
          <animated-characters
            :focused-field="animFocusedField"
            :password-length="animPasswordLength"
            :is-password-visible="animPasswordVisible"
...
export default {
  ...
  computed: {
    animFocusedField() {
      if (this.focusedField === 'confirmPassword') return 'password';
      return this.focusedField;
    },
    animPasswordLength() {
      if (this.focusedField === 'confirmPassword') return this.registerForm.confirmPassword.length;
      return this.registerForm.password.length;
    },
    animPasswordVisible() {
      if (this.focusedField === 'confirmPassword') return this.showConfirmPassword;
